 ...
 */
final class Version20240111095325 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE fds ADD products_id INT DEFAULT NULL, CHANGE description description VARCHAR(900) NOT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE fds DROP products_id, CHANGE description description VARCHAR(255) NOT NULL');
    }
}
