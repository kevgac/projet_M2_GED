 ...
 */
final class Version20240110173030 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE access_fds (id INT AUTO_INCREMENT NOT NULL, customer_id INT DEFAULT NULL, fds_id INT DEFAULT NULL, last_login_date DATETIME DEFAULT NULL, INDEX IDX_1BC6BD709395C3F3 (customer_id), INDEX IDX_1BC6BD70E3578F39 (fds_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
